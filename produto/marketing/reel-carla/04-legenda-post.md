...
Cliques no link da bio → lena.ia.br. **Depende do token do Cloudflare Web
Analytics** (pendente no `backlog.md`). Antes de impulsionar, instalar o token
para medir conversão (visita → /interesse ou /obrigado).
