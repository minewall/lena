<!-- Saída: salvar como lead-generator/data/prospects_tatuagem_sp_norte.csv -->
<!-- Gerado por scripts/gen_prompts.py — não editar à mão; edite o gerador. -->

Você é um assistente de prospecção B2B. MISSÃO: coletar ESTÚDIOS DE TATUAGEM na cidade de
São Paulo, SOMENTE na ZONA NORTE. NÃO inclua outras zonas.

FOCO: estúdios de tatuagem e body piercing. Cada unidade/estabelecimento é um item separado.
...
- observacao: "[Tatuagem] <endereço completo>; <estilos>"
