<!-- Saída: salvar como lead-generator/data/prospects_nutricao_sp_norte.csv -->
<!-- Gerado por scripts/gen_prompts.py — não editar à mão; edite o gerador. -->

Você é um assistente de prospecção B2B. MISSÃO: coletar CONSULTÓRIOS DE NUTRIÇÃO na cidade de
São Paulo, SOMENTE na ZONA NORTE. NÃO inclua outras zonas.

FOCO: consultórios de nutrição e nutricionistas (emagrecimento, esportiva, clínica). Cada unidade/estabelecimento é um item separado.
...
- observacao: "[Nutrição] <endereço completo>; <áreas>"
